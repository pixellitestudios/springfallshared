package studio.pixellite.shared.config.resolver;

import me.lucko.helper.config.ConfigurationNode;
import me.lucko.helper.config.yaml.YAMLConfigurationLoader;
import org.bukkit.Bukkit;
import studio.pixellite.shared.SharedPlugin;
import studio.pixellite.shared.config.exception.ConfigurationLoadException;
...
public final class ConfigurateResolver {
   ...
   */
  public static ConfigurationNode resolveNode(SharedPlugin plugin, String path) {
